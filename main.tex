...
\begin{figure}
\begin{center}
\subfigure[Biforcazione per $x_1$ al variare di $R$ nell'intorno di $R = 25 \Omega$.]{\includegraphics[width=0.8\textwidth]{matcont/BP_25ohm_x1}}
\vfill
\subfigure[Biforcazione per $x_2$ al variare di $R$ nell'intorno di $R = 25 \Omega$.]{\includegraphics[width=0.8\textwidth]{matcont/BP_25ohm_x2}}
...
\begin{figure}
\begin{center}
\subfigure[Ciclo per $R = 15 \Omega$.]{\includegraphics[width=0.8\textwidth]{pplane/Cycle15ohm}}
\vfill
\subfigure[Ciclo per $R = 26 \Omega$.]{\includegraphics[width=0.8\textwidth]{pplane/Cycle26ohm}}
